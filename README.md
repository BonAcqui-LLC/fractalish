...
- Full current candidate: [`Consequential_Formation_Unified_Framework_v0_3_2026-09-13.md`](Consequential_Formation_Unified_Framework_v0_3_2026-09-13.md)
- Compact current-state packet: [`CF_v0_3_Team_State_Transfer_2026-09-13.md`](CF_v0_3_Team_State_Transfer_2026-09-13.md)
- Status: CF v0.3 is a canonical candidate for orientation and state transfer, not a validated universal theory.
